...
def gen_welch_procedure_plots(in_df: df, rep_col: str, time_step_col: str, metric_col: str,
    ...
    Testing:
        ...
        Date function initially passed pytest testing: 11/14/2025
        Date non-pytest testing initially passed: 11/14/2025
        Non-pytest testing description and result: On 11/14/2025, plots produced by tests were visually
